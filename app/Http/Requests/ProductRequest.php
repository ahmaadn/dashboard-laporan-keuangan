...
class ProductRequest extends BaseFormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'harga_modal' => ['nullable', 'numeric', 'min:0', 'lte:harga'],
            'harga_grosir' => ['nullable', 'numeric', 'gt:0', 'lte:harga'],
    ...
    public function messages(): array
    {
        return [
            ...
            'harga.min' => 'Harga eceran tidak boleh negatif.',
            'harga_modal.min' => 'Harga modal tidak boleh negatif.',
            'harga_modal.lte' => 'Harga modal tidak boleh lebih besar dari harga eceran.',
            'harga_grosir.gt' => 'Harga grosir harus lebih besar dari 0.',
            'harga_grosir.lte' => 'Harga grosir tidak boleh lebih besar dari harga eceran.',
