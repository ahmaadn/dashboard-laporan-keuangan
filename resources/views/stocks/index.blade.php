...
<div x-data="stocks(@js($produk), @js($produkById), @js($currentUser))">
    ...
    <x-app-card class="mb-4">
        <div class="d-flex justify-content-between align-items-center mb-3 gap-2">
            <input type="search" class="form-control" style="max-width: 320px" placeholder="Cari produk…" x-model="search">
                ...
                <tbody>
                    <template x-for="row in visibleProducts" :key="row.id">
                        <tr :class="row.stok_rendah ? 'table-warning' : ''">
                            ...
                            <td class="text-end tnum" :class="row.stok_rendah ? 'text-danger fw-medium' : ''" x-text="row.stok"></td>
                ...
                <tbody>
                    <template x-for="m in mutasi" :key="m.id">
                        <tr>
                            ...
                            <td class="text-end tnum" :class="m.jumlah < 0 ? 'text-danger' : 'text-success'" x-text="(m.jumlah > 0 ? '+' : '') + m.jumlah"></td>
            ...
            <div class="ld-modal__body">
                <div class="ld-form-grid">
                    <div class="full">
                        ...
                        <select class="form-select" :class="errors.id_produk ? 'ld-input-invalid' : ''" x-model="form.id_produk">
                    ...
                    <div class="full">
                        ...
                        <input type="text" class="form-control" x-model="form.keterangan" placeholder="mis. Produksi 3 Mei, Restok vendor">
                    </div>
                </div>
            </div>
