    ...
    <div x-data="users(@js($pengguna), @js($currentUser))">
        ...
        <x-app-card>
            <div class="d-flex justify-content-between align-items-center mb-3 gap-2">
                <input type="search" class="form-control" style="max-width: 320px" placeholder="Cari nama, username, email…"
                    x-model="search">
                ...
                <div class="ld-modal__body">
                    <div class="ld-form-grid">
                        ...
                        <div>
                            ...
                            <input type="text" class="form-control" :class="errors.nama_pengguna ? 'ld-input-invalid' : ''"
                                x-model="form.nama_pengguna">
                            <div class="ld-field-error" x-show="errors.nama_pengguna" x-text="errors.nama_pengguna"></div>
                        </div>
                        <div>
                            <label class="form-label">Email <span class="req">*</span></label>
                            <input type="email" class="form-control" :class="errors.email ? 'ld-input-invalid' : ''"
                                x-model="form.email">
                        ...
                        <div>
                            ...
                            <input type="password" class="form-control" :class="errors.kata_sandi ? 'ld-input-invalid' : ''"
                                x-model="form.kata_sandi" :placeholder="editingId ? 'Kosongkan jika tidak diubah' : ''">
                        ...
                        <div class="full">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="usrAktif"
                                    x-model="form.aktif">
                                <label class="form-check-label" for="usrAktif"
        ...
        <div class="ld-modal" x-show="deleteTarget" x-cloak @keydown.escape.window="deleteTarget = null"
            ...
            <div class="ld-modal__dialog" style="max-width: 420px" x-transition>
                <div class="ld-modal__header">
                    <h5 class="ld-modal__title">Hapus Pengguna?</h5>
                </div>
                <div class="ld-modal__body">
                    <p class="mb-0">Akun <strong x-text="deleteTarget?.nama"></strong> akan dihapus (soft delete). Riwayat
