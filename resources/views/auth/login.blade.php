        ...
        <div class="ld-auth-grid">
            ...
            <section class="ld-auth-hero">
                <div class="ld-auth-hero__top">
                    <img src="{{ asset('logo-t.png') }}" alt="{{ config('app.name', 'BM Leather') }}"
                        class="ld-brand-logo ld-brand-logo--lg" width="44" height="44">
                ...
                <div>
                    ...
                    <p class="ld-auth-subtitle mt-4">Pencatatan pemasukan dan pengeluaran yang terstruktur, dashboard
                        interaktif, dan laporan periode — semua dalam satu tempat.</p>
                </div>
                ...
                <div class="ld-auth-card">
                    ...
                    <form method="POST" action="/login">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="namaPengguna" type="text" name="login" class="ld-auth-input" x-model="namaPengguna"
                                placeholder="mis. busari" autocomplete="username" value="{{ old('login') }}">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="position-relative">
                                <input id="kataSandi" name="password" :type="showPassword ? 'text' : 'password'"
                                    class="ld-auth-input pe-5" x-model="kataSandi" placeholder="••••••••"
                                    autocomplete="current-password">
                                <button type="button" @click="showPassword = !showPassword" class="ld-auth-toggle"
